describe('StyleHelpers', function() {
    ...
    describe('Initial state', () => {
        ...
        it('should have function getColorFromStringLegend', function() {
            ...
            expect(color).toEqual('#000000');
            legend.legendEntries.push({ 'stringValue': 'blue', 'color': '#000011', 'label': 'blue', 'sortKey': 'blue','interval': { 'min': 0, 'max': 1 }, 'value': 0 });
            legend.legendEntries.push({ 'stringValue': 'green', 'color': '#001100', 'label': 'green', 'sortKey': 'green','interval': { 'min': 0, 'max': 1 }, 'value': 0 });
        ...
        it('should have function getColorFromLegend', function() {
            ...
            legend.legendEntries.push({ stringValue: 'blue' , color: '#000011', label: 'blue', sortKey: 'blue', interval: { min: 0, max: 1 }, value: 0 });
            legend.legendEntries.push({ stringValue: 'green', color: '#001100', label: 'blue', sortKey: 'blue', interval: { min: 0, max: 1 }, value: 1 });
