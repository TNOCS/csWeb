...
declare module csComp.Services {
    ...
    class DashboardService {
        ...
        5: any;
        static $inject: string[];
        constructor($rootScope: any, $compile: any, $location: ng.ILocationService, $timeout: ng.ITimeoutService, $translate: ng.translate.ITranslateService, $messageBusService: Services.MessageBusService, $layerService: Services.LayerService, $mapService: Services.MapService);
...
declare module csComp.Services {
    ...
    class LayerService implements ILayerService {
        ...
        */
        ...
        loadTypeResources(layer: any, callback: Function): void;
