module Filters {
    ...
    export interface IWodkRowFilterScope extends ng.IScope {
    ...
    /* Custom implementation of the rowfilter for wodk */
    export class WodkRowFilterCtrl {
        private scope: IWodkRowFilterScope;
        ...
        public initRowFilter() {
            ...
            this.dcChart.width(275)
                ...
                .on('renderlet', (e) => {
                    ...
                    dc.events.trigger(() => {
                        console.log('WodkRowFilterCtrl: renderlet');
        ...
        private updateFilter() {
            setTimeout(() => {
                console.log('WodkRowFilterCtrl: updateFilter()');
        ...
        public updateRange() {
            setTimeout(() => {
                console.log('WodkRowFilterCtrl: updateRange()');
                var filter = this.$scope.filter;
                var group = filter.group;
